...
@RestController
@ApiResponses( value = {
        @ApiResponse(code= 400, message = "This is a bad request.Please follow the API documentation for proper input request."),
        @ApiResponse(code=401, message = "Access Denied.The Authentication information is missing or invalid"),
...
class CarController {
    ...
    Resource<Car> get(@PathVariable Long id) {
         ...
         */
        Car getCar =  carService.findById(id);
        return assembler.toResource(getCar);
    }
    ...
    ResponseEntity<?> post(@Valid @RequestBody Car car) throws URISyntaxException {
        ...
        Resource<Car> resource = assembler.toResource(createCar);
